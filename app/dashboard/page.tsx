          ...
          <div className="flex justify-between h-16">
            ...
            <div className="flex items-center space-x-4">
              ...
              <button
                ...
                className="px-4 py-2 bg-red-600 hover:bg-red-700 text-white rounded-lg transition duration-150"
              >
                Sign Out
              </button>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
            <div className="flex items-center">
              ...
              <div className="ml-5">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-300">Configure</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <button className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 transition duration-150">
              <div className="flex items-center">
                <svg className="h-6 w-6 text-green-600 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
                </svg>
                <span className="text-gray-900 dark:text-white font-medium">Create New Project</span>
              </div>
            ...
            <button className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 transition duration-150">
              <div className="flex items-center">
                ...
                <span className="text-gray-900 dark:text-white font-medium">Get Support</span>
              </div>
              <svg className="h-5 w-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
              </svg>
